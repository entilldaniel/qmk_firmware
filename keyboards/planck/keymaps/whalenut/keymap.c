...
[_LOWER] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______,    _______,    KC_LBRC, KC_RBRC, KC_EQL ,
    _______, _______, _______, _______, _______, _______, _______, _______,    KC_MNXT,    KC_LT  , KC_GT  , KC_MPLY
),
...
[_ARROWS] = LAYOUT_planck_grid(
    ...
    NUMS   , _______, _______, _______, MOUSE  , _______, _______, _______, _______, _______, _______, KC_END
), 
